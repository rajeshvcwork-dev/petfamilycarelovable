...
export const Route = createFileRoute("/legal/data")({
  head: () => ({ meta: [{ title: "Data Policy — PetCare Family" }] }),
  component: DataPage,
});
...
function DataPage() {
  return (
    <LegalShell title="Data & Storage Policy">
      <P>This document explains what data PetCare Family collects, why we collect it, and how it is stored.</P>
      ...
      <P>To provide the core PetCare Family experience (records, reminders, AI-powered health reviews), to keep the service secure and reliable, and to offer customer support.</P>
      <H>How it is used</H>
