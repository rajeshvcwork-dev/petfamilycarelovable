...
export const Route = createFileRoute("/legal/terms")({
  head: () => ({ meta: [{ title: "Terms & Conditions — PetCare Family" }] }),
  component: TermsPage,
});
...
function TermsPage() {
  return (
    <LegalShell title="Terms & Conditions">
      <P>By creating an account or using PetCare Family, you agree to these terms.</P>
      <H>Account usage</H>
      ...
      <P>PetCare Family provides educational pet health information and preventive recommendations. PetCare Family does not replace licensed veterinarians.</P>
      <H>Liability</H>
      <P>To the maximum extent permitted by law, PetCare Family is not liable for any indirect or consequential loss arising from use of the app.</P>
    </LegalShell>
  );
}
